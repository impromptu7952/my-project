...
return [
    ...
    */
    ...
    'default_for_images' => env('AI_DEFAULT_IMAGES', 'xai'),
    ...
    */
    ...
    'providers' => [
        ...
        'xai' => [
            ...
            'models' => [
                'text' => [
                    'default' => env('XAI_MODEL', env('APP_ENV') === 'local' ? 'grok-4.3' : 'grok-4.5'),
                    'cheapest' => env('XAI_MODEL_CHEAPEST', 'grok-4.3'),
                    'smartest' => env('XAI_MODEL_SMARTEST', 'grok-4.5'),
                ],
                'image' => [
